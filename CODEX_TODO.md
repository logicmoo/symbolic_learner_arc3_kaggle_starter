...
- Active branch: `codex/systems-menu`
- Remote branch: `origin/codex/systems-menu`
- Latest validated commit: `161bde7` (`Use one root Python environment`)
...
```powershell
Get-NetTCPConnection -State Listen -LocalPort 16666,17777 |
...
Preserve the canonical checkout and its `codex/systems-menu` branch.
