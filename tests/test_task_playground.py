...
from task_api import invoke_task
from task_resolution import materialize_workflow_step


def test_task_playground_invokes_python_variant() -> None:
    result = invoke_task(
        "shared",
...
def test_task_materialization_resolves_requested_prompt_variant() -> None:
