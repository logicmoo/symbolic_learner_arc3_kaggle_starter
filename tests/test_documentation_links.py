...
def test_file_tree_links_all_connected_architecture_files() -> None:
    ...
    expected = {
        ...
        "python/omega_vision/models.py",
        "python/omega_vision/providers.py",
        "python/omega_vision/forms.py",
        "python/omega_vision/adapters.py",
        "python/omega_vision/memory.py",
        "python/omega_vision/prediction.py",
        "python/omega_vision/learning.py",
        "python/omega_vision/integration.py",
