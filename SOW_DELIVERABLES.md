...
- [ ] **Partial** Support deterministic semantic-memory replay and reproducible updates from the debugger’s recorded history.
  ...
  Recorded trees can replay into either the durable Prolog backend or `AtomSpaceSemanticBackend`, then hydrate exact typed records and facade indexes after process restart.
