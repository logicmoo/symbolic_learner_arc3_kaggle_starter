# `ls20` level `1` — LEFT / LEFT / LEFT / UP
...
enclosed_by(current, central_hole, [green_structure,base_glyph]).
...
object_bbox(current, base_glyph, 19, 40, 23, 44).
object_shape(current, base_glyph, layered([
    rectangle(19,40,23,41,gray),
    rectangle(19,42,23,44,dark_red)
])).
...
object_bbox(current, status_marker, 13, 61, 16, 62).
object_shape(current, status_marker, rectangle(13,61,16,62,green)).
...
turtle_program(green_structure, [set_color(green),fill_rect(32,8,40,8),fill_rect(32,9,32,15),fill_rect(40,9,40,15),fill_rect(32,16,40,16),fill_rect(34,17,38,24),fill_rect(14,25,53,29),fill_rect(14,30,28,39),fill_rect(34,30,53,44),fill_rect(19,45,53,49),set_color(gray),fill_rect(33,9,39,15)]).
...
turtle_program(base_glyph, [set_color(gray),fill_rect(19,40,23,41),set_color(dark_red),fill_rect(19,42,23,44)]).
...
turtle_program(status_marker, [set_color(green),fill_rect(13,61,16,62)]).
...
````prolog
turtle_from_diff(parent_to_current, [
    set_color(gray),fill_rect(19,40,23,41),
    set_color(dark_red),fill_rect(19,42,23,44),
    set_color(green),fill_rect(19,45,23,49),
    set_color(green),fill_rect(14,61,16,62)
]).
````
...
````prolog
turtle_from_image(current_frame, [
    clear(yellow),
    set_color(gray),fill_rect(0,0,3,51),
    set_color(green),fill_rect(32,8,40,8),fill_rect(32,9,32,15),fill_rect(40,9,40,15),fill_rect(32,16,40,16),fill_rect(34,17,38,24),fill_rect(14,25,53,29),fill_rect(14,30,28,39),fill_rect(34,30,53,44),fill_rect(19,45,53,49),
    ...
    set_color(green),fill_rect(13,61,16,62),
