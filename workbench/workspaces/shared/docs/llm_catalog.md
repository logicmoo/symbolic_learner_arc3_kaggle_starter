...
Profiles are deliberately prompt-free. Changing temperature or reasoning effort should not silently change what operation the LLM is being asked to perform.
