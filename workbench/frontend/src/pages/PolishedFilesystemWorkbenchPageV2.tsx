...
type Snapshot = {
  ...
  tasks: RecordFile<ResourceDef>[];
  taskImplementations?: RecordFile<ResourceDef>[];
...
type View = "flow" | "studio" | "data" | "tasks" | "models" | "prompts" | "evidence" | "checks" | "setup";
...
export function PolishedFilesystemWorkbenchPageV2() {
  ...
  const taskRecords = useMemo(() => [...(snapshot?.tasks || []),...(snapshot?.taskImplementations || [])], [snapshot]);
