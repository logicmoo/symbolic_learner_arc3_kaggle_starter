...
const COMBINED_PROMPT_PARTS = [
  ...
  "",
  "QUALITY CONTROL: Before returning, verify that the result parses as strict JSON, contains all eleven required keys (plus optional exit_value only), uses no Markdown fences, uses no opaque object IDs, uses only logical grid coordinates, and contains syntactically plausible SWI-Prolog source in every nonempty *_pl string with correct JSON escaping.",
];
...
const GAP_DISCOVERY_PASS_PROMPT = [
  ...
  "Do not duplicate existing IDs. Add sub_type and tight bounding_box for every newly discovered entity.",
