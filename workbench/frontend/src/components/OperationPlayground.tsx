...
type OperationDef={id:string;label?:string;inputs?:Record<string,string>;outputs?:Record<string,string>;implementationSelection?:{default?:string;variants?:string[]}};
...
export function OperationPlayground({workspaceId,operation,variants}:{workspaceId:string;operation:OperationDef;variants:OperationImplementationDef[]}){
 const preferred=operation.implementationSelection?.default||variants[0]?.id||"";
