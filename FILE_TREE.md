...
- [`workbench/docs/design/EXECUTIVE_VISION.md`](workbench/docs/design/EXECUTIVE_VISION.md) — executive thesis that structured orchestration, memory, evidence, validation, and model coaching can make both frontier and non-frontier models substantially more capable.
- [`workbench/docs/design/WORKFLOW_CONTROL_LANGUAGE.md`](workbench/docs/design/WORKFLOW_CONTROL_LANGUAGE.md) — minimal model-generated workflow language, AtomSpace memory ports, values, conditionals, loops, call/return behavior, preflight rules, and bounded execution semantics.
- [`workbench/docs/design/SEMANTIC_WORKFLOW_TO_RUNTIME_IMPLEMENTATION.md`](workbench/docs/design/SEMANTIC_WORKFLOW_TO_RUNTIME_IMPLEMENTATION.md) — two-stage semantic workflow generation and runtime implementation resolution, including Bicameral Mode CoT and coaching cadence.
...
- [`workbench/frontend/src/components/HelpDocumentTabs.tsx`](workbench/frontend/src/components/HelpDocumentTabs.tsx) — right-side contextual filesystem Markdown tabs, with Contents first, a Theses tab, and repository-link navigation available from every active page.
...
- [`workbench/server/model_policy_todo_api.py`](workbench/server/model_policy_todo_api.py) — exposes the implemented policy specification, remaining follow-ups, and acceptance image from disk.
...
- [`workbench/workspaces/shared_library_system/docs/contents.md`](workbench/workspaces/shared_library_system/docs/contents.md) — first tab in the right-side Documentation inspector and filesystem-backed index into every shared help section, the project theses, design documents, and repository Docs explorer.
...
- [`workbench/workspaces/shared_library_system/design/operations/control_loops.operation.metta`](workbench/workspaces/shared_library_system/design/operations/control_loops.operation.metta), [`control_conditionals.operation.metta`](workbench/workspaces/shared_library_system/design/operations/control_conditionals.operation.metta), and [`workflow_language_primitives.operation.metta`](workbench/workspaces/shared_library_system/design/operations/workflow_language_primitives.operation.metta) — shared bounded loop, conditional branch/call, value, AtomSpace memory, break/continue, and return primitives for model-generated workflows.
- [`workbench/workspaces/shared_library_system/design/operations/populate_workflow_from_english.operation.metta`](workbench/workspaces/shared_library_system/design/operations/populate_workflow_from_english.operation.metta) — semantic workflow compiler operation with MeTTa and JSON LLM implementation children.
- [`workbench/workspaces/shared_library_system/design/prompts/generate_workflow_from_english.prompt.metta`](workbench/workspaces/shared_library_system/design/prompts/generate_workflow_from_english.prompt.metta), [`generate_workflow_from_english.metta.prompt.metta`](workbench/workspaces/shared_library_system/design/prompts/generate_workflow_from_english.metta.prompt.metta), and [`generate_workflow_from_english.json.prompt.metta`](workbench/workspaces/shared_library_system/design/prompts/generate_workflow_from_english.json.prompt.metta) — constrained semantic workflow compiler prompt and strict MeTTa/JSON variants.
- [`workbench/workspaces/shared_library_system/design/prompts/plan_workflow_memory_and_values.prompt.metta`](workbench/workspaces/shared_library_system/design/prompts/plan_workflow_memory_and_values.prompt.metta) and [`plan_workflow_memory_and_values.default.prompt.metta`](workbench/workspaces/shared_library_system/design/prompts/plan_workflow_memory_and_values.default.prompt.metta) — shared planner for AtomSpace memory, value lifecycles, iteration groups, and reevaluation checkpoints.
...
- [`workbench/workspaces/arc3_random_player/docs/ARC3_RANDOM_PLAYER_WORKFLOW_ENGLISH.md`](workbench/workspaces/arc3_random_player/docs/ARC3_RANDOM_PLAYER_WORKFLOW_ENGLISH.md) and [`workbench/workspaces/arc3_random_player/design/prompts/arc3_random_player_english_specification.prompt.metta`](workbench/workspaces/arc3_random_player/design/prompts/arc3_random_player_english_specification.prompt.metta) — ARC3-specific human-readable workflow specification and first-class prompt resource consumed by the shared workflow compiler.
...
- [`workbench/workspaces/titlecase_demo/design/workflows/titlecase_demo.workflow.metta`](workbench/workspaces/titlecase_demo/design/workflows/titlecase_demo.workflow.metta) and [`workbench/workspaces/review_with_approval/design/workflows/review_with_approval.workflow.metta`](workbench/workspaces/review_with_approval/design/workflows/review_with_approval.workflow.metta) — runnable examples in dedicated application workspaces; shared libraries provide their reusable operations but own no workflows.
