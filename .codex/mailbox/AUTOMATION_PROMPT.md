...
await any active `agent_mailbox.py poll symbolic-workbench-codex` subprocess. Never start an
...
python agent_mailbox.py poll symbolic-workbench-codex --interval 30 --checks 10 --require-port 46667
...
This workspace uses the stable identity `symbolic-workbench-codex`, the
